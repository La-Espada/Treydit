...
import com.irgek.Treydit.presentation.api.email.EmailSender;
import com.irgek.Treydit.presentation.api.email.EmailService;
import com.irgek.Treydit.presentation.api.registration.EmailValidatior;
...
public class RegistrationService {
    ...
    private final EmailValidatior emailValidatior;
    private final ConfirmationTokenService confirmationTokenService;
    private final EmailSender emailSender;

    public String register(RegistrationRequest registrationRequest){
        boolean emailValid = emailValidatior
                .test(registrationRequest.getEmail());
        if(!emailValid){
            throw new IllegalStateException("Email not valid");
        }
        String token = treyderService.signUpTreyder(
                new Treyder(
    ...
    public String confirmToken(String token){
        ...
        treyderService.enableTreyder(confirmationToken.getTreyder().getEmail());
